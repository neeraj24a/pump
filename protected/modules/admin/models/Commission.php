 ...
 */
class Commission extends AdminBaseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id, product_type, amount, created_by, updated_by, date_entered, date_modified', 'required'),
			array('status, deleted', 'numerical', 'integerOnly'=>true),
			array('id, product_type, created_by, updated_by', 'length', 'max'=>36),
			array('amount', 'length', 'max'=>16),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, product_type, amount, status, deleted, created_by, updated_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}
