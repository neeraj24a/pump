            ...
            <div class="box">
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . '/admin/expenses/create'; ?>">
                                <button class="btn btn-block btn-primary">Add Expense</button>
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        array(
                                            ...
                                            'buttons' => array(
                                                'v' => array(
                                                    ...
                                                    'url' => 'Yii::app()->createUrl("admin/expenses/view", array("id"=>$data->id))',
                                                    'options' => array('class' => 'view', 'title' => 'View'),
                                                ),
                                                'u' => array(
                                                    'label' => '<i class="fa fa-edit"></i>',
                                                    'url' => 'Yii::app()->createUrl("admin/expenses/update", array("id"=>$data->id))',
                                                    'options' => array('class' => 'edit', 'title' => 'Update'),
                                                ),
                                                'd' => array(
                                                    'label' => '<i class="fa fa-trash"></i>',
                                                    'url' => 'Yii::app()->createUrl("admin/expenses/delete", array("id"=>$data->id))',
