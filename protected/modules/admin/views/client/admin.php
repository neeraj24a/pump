<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url() . '/admin/client'; ?>"><i class="fa fa-dashboard"></i> client</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . '/admin/client/create'; ?>">
                                <button class="btn btn-block btn-primary">Add Client</button>
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        array(
                                            ...
                                            'buttons' => array(
                                                'v' => array(
                                                    ...
                                                    'url' => 'Yii::app()->createUrl("admin/client/view", array("id"=>$data->id))',
                                                    'options' => array('class' => 'view', 'title' => 'View'),
                                                ),
                                                'u' => array(
                                                    'label' => '<i class="fa fa-edit"></i>',
                                                    'url' => 'Yii::app()->createUrl("admin/client/update", array("id"=>$data->id))',
