            ...
            <div class="box">
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . '/admin/sale/create'; ?>">
                                <button class="btn btn-block btn-primary">Add Sale</button>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 table-responsive">
                                ...
                                $this->widget('zii.widgets.grid.CGridView', array(
                                    ...
                                    'columns' => array(
										array(
                                            'name' => '<a class="sort-link" href="javascript:void(0);">Product</a>',
                                        	'type'=>'raw',
											'value' => array($this, 'getProduct'),
                                        ),
										array(
                                            'name' => '<a class="sort-link" href="javascript:void(0);">Nozzle</a>',
										    'value' => array($this, 'getNozzle'),
                                        ),
                                        'opening_meter',
										'closing_meter',
										'sale_quantity',
                                        ...
                                        array(
                                            ...
                                            'buttons' => array(
                                                'v' => array(
                                                    ...
                                                    'url' => 'Yii::app()->createUrl("admin/sale/view", array("id"=>$data->id))',
                                                    'options' => array('class' => 'view', 'title' => 'View'),
                                                ),
                                                'u' => array(
                                                    'label' => '<i class="fa fa-edit"></i>',
                                                    'url' => 'Yii::app()->createUrl("admin/sale/update", array("id"=>$data->id))',
                                                    'options' => array('class' => 'edit', 'title' => 'Update'),
                                                ),
                                                'd' => array(
                                                    'label' => '<i class="fa fa-trash"></i>',
                                                    'url' => 'Yii::app()->createUrl("admin/sale/delete", array("id"=>$data->id))',
